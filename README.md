...
A lightweight Docker base image combining Go 1.26.4 Alpine with JasperStarter for report generation.

## What's Included

- **Go 1.26.4** - Go programming language
...
- `ghcr.io/unlockedlabs/golang-jasper:1.26.4-3.6.2` - Version specific tag
...
```dockerfile
FROM ghcr.io/unlockedlabs/golang-jasper:1.26.4-3.6.2
...
docker pull ghcr.io/unlockedlabs/golang-jasper:1.26.4-3.6.2
```
...
# or build manually
docker build -t ghcr.io/unlockedlabs/golang-jasper:1.26.4-3.6.2 .
docker tag ghcr.io/unlockedlabs/golang-jasper:1.26.4-3.6.2 ghcr.io/unlockedlabs/golang-jasper:latest
```
...
git tag v1.26.4-3.6.2
git push origin v1.26.4-3.6.2
```
...
```bash
docker run --rm ghcr.io/unlockedlabs/golang-jasper:1.26.4-3.6.2 go version
docker run --rm ghcr.io/unlockedlabs/golang-jasper:1.26.4-3.6.2 jasperstarter --version
```
